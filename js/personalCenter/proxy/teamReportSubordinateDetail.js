...
function teamReportSubordinateDetailInit(){
    $("#teamReportSubordinateDetailUlId").empty();
    var $SubordinateDetailUl=$('<ul class="recordDetail"><li>充 值：<span id="charge_sd"></span></li>' +
        '<li>提 款：<span id="withdrawal_sd"></span></li>' +
        '<li>购 彩：<span id="buyLottery_sd"></span></li>' +
        '<li>返 点：<span id="point_sd"></span></li>' +
        '<li>中 奖：<span id="prize_sd"></span></li>' +
        '<li style="display: none;">日工资：<span id="dailywage_sd"></span></li>' +
        '<li>手续费：<span id="feeMoney_sd"></span></li>' +
        '<li>其 他：<span id="others_sd"></span></li>' +
        '<li>盈 亏：<span id="loss_sd"></span></li></ul>');
    ...
    $("#feeMoney_sd").html(teamReportSubordinate.FeeMoneyTotal);
