...
function teamReportSelfInit(){
    ...
    var $SelfUL=$('<ul class="recordDetail"><li>自 身：<span id="selfUser_Self"></span></li>' +
        '<li>直 属：<span id="child_Self"></span></li>' +
        '<li>团 队：<span id="team_Self"></span></li>' +
        '<li>充值总额：<span id="charge_Self"></span></li>' +
        '<li>提款总额：<span id="withdrawal_Self"></span></li>' +
        '<li>购彩总额：<span id="buyLottery_Self"></span></li>' +
        '<li>返点总额：<span id="point_Self"></span></li>' +
        '<li>中奖总额：<span id="prize_Self"></span></li>' +
        '<li style="display: none;">日工资：<span id="dailywage_Self"></span></li>' +
        '<li>手 续 费：<span id="feeMoney_Self"></span></li>' +
        '<li>其他收入：<span id="others_Self"></span></li>' +
        '<li>盈利总额：<span id="winTotal_Self"></span></li></ul>');
...
function teamReportSelfSuccessCallBack(data) {
	if (data.SystemState == 64) {
		...
		$("#feeMoney_Self").html(data.ReportComm[0].FeeMoneyTotal);
