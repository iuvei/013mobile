...
function zhuiHaoBettingOrderDetailsInit(){
		...
		$("#orderDetails_Id_zh").html(bettingIndex.orderId);
      ...
      searchOrder_zh(bettingIndex.lotteryType, bettingIndex.orderId);
...
function searchSuccessCallBack_zh(data) {
	...
	$("#orderList_zh").empty();
	$("#orderList_zh").append('<li id="list_divider_id" style="background:#999; color:#FFFFFF;padding:6px 16px;font-size: 16px;margin:10px 0 0;">购 买 号 码</li>');
