...
function myChargeRecordInit(){
    ...
    var $selectType_charge = $('<select name="myChargeRecordsearchType" id="myChargeRecordsearchType" data-theme="a" data-mini="true" onchange="myChargeRecordtypeChange()"><option value="null" selected="selected">状态：全部</option><option value="1">状态：交易成功</option><option value="2">状态：交易失败</option><option value="0">状态：未处理</option></select>');
