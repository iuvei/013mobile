 ...
 * @return {[type]}      [description]
 */
function blanydwfcValidateData(data){
    blanydwfcValidData(data.value);
}

function blanydwfcValidData(str){
    var notes = 0;
    var array;
    if(blanydwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#blanydwfc_tab .button.red").size() ,2);
        blanydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#blanydwfc_tab .button.red").size() ,3);
        blanydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#blanydwfc_tab .button.red").size() ,4);
        blanydwfcShowFooter(true,notes);
    }
