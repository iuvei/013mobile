 ...
 * @return {[type]}      [description]
 */
function jsffcValidateData(data){
	jsffcValidData(data.value);
}

function jsffcValidData(str){
    var notes = 0;
    var array;
    if(jsffc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#jsffc_tab .button.red").size() ,2);
        jsffcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jsffc_tab .button.red").size() ,3);
        jsffcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jsffc_tab .button.red").size() ,4);
        jsffcShowFooter(true,notes);
    }
