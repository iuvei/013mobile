 ...
 * @return {[type]}      [description]
 */
function jssfcValidateData(data){
	jssfcValidData(data.value);
}

function jssfcValidData(str){
    var notes = 0;
    var array;
    if(jssfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#jssfc_tab .button.red").size() ,2);
        jssfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jssfc_tab .button.red").size() ,3);
        jssfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jssfc_tab .button.red").size() ,4);
        jssfcShowFooter(true,notes);
    }
