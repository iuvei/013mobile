 ...
 * @return {[type]}      [description]
 */
function qqffcValidateData(data){
	qqffcValidData(data.value);
}

function qqffcValidData(str){
    var notes = 0;
    var array;
    if(qqffc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#qqffc_tab .button.red").size() ,2);
        qqffcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#qqffc_tab .button.red").size() ,3);
        qqffcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#qqffc_tab .button.red").size() ,4);
        qqffcShowFooter(true,notes);
    }
