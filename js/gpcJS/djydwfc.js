 ...
 * @return {[type]}      [description]
 */
function djydwfcValidateData(data){
    djydwfcValidData(data.value);
}

function djydwfcValidData(str){
    var notes = 0;
    var array;
    if(djydwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#djydwfc_tab .button.red").size() ,2);
        djydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#djydwfc_tab .button.red").size() ,3);
        djydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#djydwfc_tab .button.red").size() ,4);
        djydwfcShowFooter(true,notes);
    }
