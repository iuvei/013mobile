 ...
 * @return {[type]}      [description]
 */
function xjsscValidateData(data){
	xjsscValidData(data.value);
}

function xjsscValidData(str){
	var notes = 0;
	var array;
	if(xjssc_playMethod == 1){
		...
		notes = array.length * mathUtil.getCCombination($("#xjssc_tab .button.red").size() ,2);
		xjsscShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#xjssc_tab .button.red").size() ,3);
		xjsscShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#xjssc_tab .button.red").size() ,4);
		xjsscShowFooter(true,notes);
	}
