 ...
 * @return {[type]}      [description]
 */
function cqsscValidateData(data){
	cqsscValidData(data.value);
}

function cqsscValidData(str){
    var notes = 0;
    var array;
    if(cqssc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#cqssc_tab .button.red").size() ,2);
        cqsscShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#cqssc_tab .button.red").size() ,3);
        cqsscShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#cqssc_tab .button.red").size() ,4);
        cqsscShowFooter(true,notes);
    }
