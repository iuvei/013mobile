 ...
 * @return {[type]}      [description]
 */
function mmcValidateData(data){
	mmcValidData(data.value);
}

function mmcValidData(str){
    var notes = 0;
    var array;
    if(mmc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#mmc_tab .button.red").size() ,2);
        mmcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#mmc_tab .button.red").size() ,3);
        mmcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#mmc_tab .button.red").size() ,4);
        mmcShowFooter(true,notes);
    }
