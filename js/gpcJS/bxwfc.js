 ...
 * @return {[type]}      [description]
 */
function bxwfcValidateData(data){
    bxwfcValidData(data.value);
}

function bxwfcValidData(str){
    var notes = 0;
    var array;
    if(bxwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#bxwfc_tab .button.red").size() ,2);
        bxwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#bxwfc_tab .button.red").size() ,3);
        bxwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#bxwfc_tab .button.red").size() ,4);
        bxwfcShowFooter(true,notes);
    }
