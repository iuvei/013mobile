 ...
 * @return {[type]}      [description]
 */
function hgydwfcValidateData(data){
    hgydwfcValidData(data.value);
}

function hgydwfcValidData(str){
    var notes = 0;
    var array;
    if(hgydwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#hgydwfc_tab .button.red").size() ,2);
        hgydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#hgydwfc_tab .button.red").size() ,3);
        hgydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#hgydwfc_tab .button.red").size() ,4);
        hgydwfcShowFooter(true,notes);
    }
