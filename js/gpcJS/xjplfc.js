 ...
 * @return {[type]}      [description]
 */
function xjplfcValidateData(data){
	xjplfcValidData(data.value);
}

function xjplfcValidData(str){
	var notes = 0;
	var array;
	if(xjplfc_playMethod == 1){
		...
		notes = array.length * mathUtil.getCCombination($("#xjplfc_tab .button.red").size() ,2);
		xjplfcShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#xjplfc_tab .button.red").size() ,3);
		xjplfcShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#xjplfc_tab .button.red").size() ,4);
		xjplfcShowFooter(true,notes);
	}
