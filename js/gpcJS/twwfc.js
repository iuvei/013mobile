 ...
 * @return {[type]}      [description]
 */
function twwfcValidateData(data){
    twwfcValidData(data.value);
}

function twwfcValidData(str){
    var notes = 0;
    var array;
    if(twwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#twwfc_tab .button.red").size() ,2);
        twwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#twwfc_tab .button.red").size() ,3);
        twwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#twwfc_tab .button.red").size() ,4);
        twwfcShowFooter(true,notes);
    }
