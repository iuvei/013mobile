 ...
 * @return {[type]}      [description]
 */
function jndsdwfcValidateData(data){
    jndsdwfcValidData(data.value);
}

function jndsdwfcValidData(str){
    var notes = 0;
    var array;
    if(jndsdwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#jndsdwfc_tab .button.red").size() ,2);
        jndsdwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jndsdwfc_tab .button.red").size() ,3);
        jndsdwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#jndsdwfc_tab .button.red").size() ,4);
        jndsdwfcShowFooter(true,notes);
    }
