 ...
 * @return {[type]}      [description]
 */
function tjsscValidateData(data){
	tjsscValidData(data.value);
}

function tjsscValidData(str){
    var notes = 0;
    var array;
    if(tjssc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#tjssc_tab .button.red").size() ,2);
        tjsscShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#tjssc_tab .button.red").size() ,3);
        tjsscShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#tjssc_tab .button.red").size() ,4);
        tjsscShowFooter(true,notes);
    }
