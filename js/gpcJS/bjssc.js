 ...
 * @return {[type]}      [description]
 */
function bjsscValidateData(data){
	bjsscValidData(data.value);
}

function bjsscValidData(str){
	var notes = 0;
    var array;
	if(bjssc_playMethod == 1){
		...
		notes = array.length * mathUtil.getCCombination($("#bjssc_tab .button.red").size() ,2);
		bjsscShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#bjssc_tab .button.red").size() ,3);
		bjsscShowFooter(true,notes);
		...
		notes = array.length * mathUtil.getCCombination($("#bjssc_tab .button.red").size() ,4);
		bjsscShowFooter(true,notes);
	}
