 ...
 * @return {[type]}      [description]
 */
function blydwfcValidateData(data){
    blydwfcValidData(data.value);
}

function blydwfcValidData(str){
    var notes = 0;
    var array;
    if(blydwfc_playMethod == 1){
        ...
        notes = array.length * mathUtil.getCCombination($("#blydwfc_tab .button.red").size() ,2);
        blydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#blydwfc_tab .button.red").size() ,3);
        blydwfcShowFooter(true,notes);
        ...
        notes = array.length * mathUtil.getCCombination($("#blydwfc_tab .button.red").size() ,4);
        blydwfcShowFooter(true,notes);
    }
